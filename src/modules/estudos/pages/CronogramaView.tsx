...
const CronogramaView: React.FC<CronogramaViewProps> = ({
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      // Nota: As revisões automáticas são geradas exclusivamente quando o aluno conclui um estudo (via syncPlannedReviewsDb).
      // Não geramos mais revisões antecipadas/especulativas para matérias que ainda estão apenas planejadas.
