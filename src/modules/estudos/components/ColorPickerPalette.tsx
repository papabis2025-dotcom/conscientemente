  ...
  return (
    <div className="space-y-2">
      ...
      <div className="p-3 bg-zinc-50/80 dark:bg-zinc-800/60 rounded-2xl border border-zinc-200/80 dark:border-zinc-700/80">
        <div className="grid grid-cols-7 sm:grid-cols-9 md:grid-cols-12 gap-1.5 justify-items-center">
          {PRESET_PALETTE_COLORS.map((c) => {
            ...
            return (
              ...
              >
                {isSelected && (
                  <Check size={11} className="text-white drop-shadow-[0_1px_1px_rgba(0,0,0,0.8)]" strokeWidth={3} />
                )}
              </button>
            );
          })}
